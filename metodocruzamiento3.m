...
switch n
    ...
    case 2 %2 POINT CROSSOVER
        for k=1:np/4
            ...
            hijobin(2*k-1, :)=[padresbin(2*k-2,1:p1) padresbin(2*k+1,p1+1:p2) padresbin(2*k-2,p2+1:nbits)];
            hijobin(2*k, :)=[padresbin(2*k-1,1:p1) padresbin(2*k,p1+1:p2) padresbin(2*k-1,p2+1:nbits)];
