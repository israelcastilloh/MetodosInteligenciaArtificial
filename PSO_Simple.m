...
%función a graficar
x1 = -10:0.01:10;%definir tamaño de paso / intervalo
x2 = -10:0.01:10;
...
c1=0.50; %Velocidad de convergencia
c2=0.50; %velocidad de convergencia
...
for i=1:100 %Número de generaciones
    ...
    fx= -(3*x1p+2*x2p + a*max(x1p-4,0) + ... 
        a*max(0*x1p+2*x2p-12,0) + a*max(3*x1p+2*x2p-18,0) +...
